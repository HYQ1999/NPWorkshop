...
class ShenGouMsgResposity: NSObject {
    ...
    func shengouMesage()
    {
        ...
        if userlist.userlist.isEmpty
        {
            ...
            Alamofire.request("http://172.16.101.66:8083/api/RepAPI/Message_Apply", method: .post, parameters:parameters,encoding: JSONEncoding.default, headers: nil).responseJSON { response in
