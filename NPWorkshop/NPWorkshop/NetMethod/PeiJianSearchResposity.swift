...
class PeiJianSearchResposity: NSObject {

    func Search(requesting: Models_PeiJianSearch.Requesting)
    {
        userlist.loadData()
        ...
        var Response: [Models_PeiJianSearch.Response]? = [Models_PeiJianSearch.Response(RepairID: nil, EqptName: nil, RepairState: nil)]
        ...
        Alamofire.request("http://172.16.101.66:8083/api/RepAPI/RepairList", method: .post, parameters:parameters,encoding: JSONEncoding.default, headers: nil).responseJSON { response in
            ...
            NotificationCenter.default.post(name: Notification.Name(rawValue: "Models_PeiJianSearch"), object: Response)
