...
import Alamofire
import SwiftyJSON
class WeixiuSearchResposity: NSObject {

    func Search(requesting: Models_WeixiuSearch.Requesting)
    {
        ...
        Response?.removeAll()
          ...
          Alamofire.request("http://172.16.101.66:8083/api/RepAPI/PostRepLists", method: .post, parameters:parameters,encoding: JSONEncoding.default, headers: nil).responseJSON { response in
            if response.result.value != nil {
              ...
              NotificationCenter.default.post(name: Notification.Name(rawValue: "Models_WeixiuSearch"), object: Response)
