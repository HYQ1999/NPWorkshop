...
class JieXiuSearchResposity: NSObject {

    
    func Search(requesting: Models_JieXiuSearch.Requesting)
    {
        userlist.loadData()
        ...
        Alamofire.request("http://172.16.101.66:8083/api/RepAPI/PostRepLists", method: .post, parameters:parameters,encoding: JSONEncoding.default, headers: nil).responseJSON { response in
            ...
            NotificationCenter.default.post(name: Notification.Name(rawValue: "Models_JieXiuSearch"), object: Response)
