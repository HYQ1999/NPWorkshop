...
class ManShengouModel: NSObject {
    var Manpeijianlist = [ManshengouList]()
    ...
    func saveData() {
        ...
        archiver.encode(Manpeijianlist, forKey: "Manpeijianlist")
        //编码结束
    ...
    func loadData() {
        ...
        if defaultManager.fileExists(atPath: path) {
            ...
            Manpeijianlist = unarchiver.decodeObject(forKey: "Manpeijianlist") as! Array
            //结束解码
    ...
    func dataFilePath ()->String{
        return self.documentsDirectory().appendingFormat("/ManPeijianList.plist")
    }
}
