...
class JiexiuModel: NSObject {
    var jxlist = [JiexiuList]()
    ...
    func saveData() {
        ...
        archiver.encode(jxlist, forKey: "jxlist")
        //编码结束
    ...
    func loadData() {
        ...
        if defaultManager.fileExists(atPath: path) {
            ...
            jxlist = unarchiver.decodeObject(forKey: "jxlist") as! Array
            //结束解码
    ...
    func dataFilePath ()->String{
        return self.documentsDirectory().appendingFormat("/Jxlist.plist")
    }
}
