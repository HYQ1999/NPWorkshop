...
import Alamofire
import SwiftyJSON
class CheXiaoViewController: UIViewController {
    ...
    @IBOutlet weak var chexiaoyuanyin: UITextView!
...
//
     ...
     func xianshi()
    {
        ...
        chexiaoyuanyin.text = detaillist.detail[0].CancelReason
