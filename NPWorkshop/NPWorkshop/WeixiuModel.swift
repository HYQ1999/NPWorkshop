...
class WeixiuModel: NSObject {
    var wxlist = [WeixiuList]()
    ...
    func saveData() {
        ...
        archiver.encode(wxlist, forKey: "wxlist")
        //编码结束
    ...
    func loadData() {
        ...
        if defaultManager.fileExists(atPath: path) {
            ...
            wxlist = unarchiver.decodeObject(forKey: "wxlist") as! Array
            //结束解码
    ...
    func dataFilePath ()->String{
        return self.documentsDirectory().appendingFormat("/Wxlist.plist")
    }
}
